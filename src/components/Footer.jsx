      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul>
              <li><a href="#" className="text-gray-400 hover:text-white flex items-center"><i className="fab fa-facebook-f mr-2"></i> Facebook</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white flex items-center"><i className="fab fa-twitter mr-1"></i> Twitter</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white flex items-center"><i className="fab fa-instagram mr-2"></i> Instagram</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white flex items-center"><i className="fab fa-linkedin mr-2"></i> LinkedIn</a></li>
            </ul>
          </div>
